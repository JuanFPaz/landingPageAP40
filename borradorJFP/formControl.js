...
function crearFormularioRegistroCuenta() {
  ...
  <div class="row m-4 p-12">
      <div class="col-12">
          ...
          <input type="password" class="form-control" id="password2" placeholder="Rapita la contraseña"
              name="password2">
      </div>
  </div>
  ...
  <div class="row m-4">
      <div class="col-12">
          <button type="submit" class="btn btn-outline-success w-100 d-block d-md-inline text-verde">
              Registarse
          </button>
      </div>
  </div>
